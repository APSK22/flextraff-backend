...
class TestAPIIntegration:
    ...
    @pytest.mark.asyncio
    async def test_traffic_calculation_integration(self, aio_session: aiohttp.ClientSession):
    ...
    @pytest.mark.asyncio
    async def test_vehicle_detection_integration(self, aio_session: aiohttp.ClientSession):
    ...
    @pytest.mark.asyncio
    async def test_junction_status_integration(self, aio_session: aiohttp.ClientSession):
        ...
        async with aio_session.get(f"{self.API_BASE_URL}/junction/{junction_id}/status") as response:
            assert response.status == 200
            data = await response.json()
    ...
    async def test_live_timing_integration(self, aio_session: aiohttp.ClientSession):
        ...
        # Test live timing
        async with aio_session.get(f"{self.API_BASE_URL}/junction/{junction_id}/live-timing") as response:
            assert response.status == 200
            data = await response.json()
    ...
    @pytest.mark.asyncio
    async def test_live_timing_custom_time_window(self, aio_session: aiohttp.ClientSession):
    ...
    @pytest.mark.asyncio
    async def test_junction_history_integration(self, aio_session: aiohttp.ClientSession):
        ...
        async with aio_session.get(f"{self.API_BASE_URL}/junction/{junction_id}/history") as response:
            assert response.status == 200
            data = await response.json()
    ...
    async def test_daily_summary_integration(self, aio_session: aiohttp.ClientSession):
        ...
        async with aio_session.get(f"{self.API_BASE_URL}/analytics/daily-summary") as response:
            assert response.status == 200
            data = await response.json()
            ...
            calculated_total = sum(s["total_vehicles"] for s in data["junction_summaries"])
...
class TestAPIErrorHandling:
    ...
    async def test_invalid_junction_id(self, aio_session: aiohttp.ClientSession):
        ...
        async with aio_session.get(f"{self.API_BASE_URL}/junction/{invalid_id}/status") as response:
            assert response.status == 404
        
        # Test live timing with invalid ID
        async with aio_session.get(f"{self.API_BASE_URL}/junction/{invalid_id}/live-timing") as response:
            # Should return 200 but with empty/zero data
            assert response.status == 200
        
        # Test junction history with invalid ID
        async with aio_session.get(f"{self.API_BASE_URL}/junction/{invalid_id}/history") as response:
    ...
    async def test_invalid_request_data(self, aio_session: aiohttp.ClientSession):
        ...
        invalid_detections = [
            {},  # Missing fields
            {"junction_id": -1, "lane_number": 1, "fastag_id": "TEST", "vehicle_type": "car"},  # Invalid junction
            {"junction_id": 1, "lane_number": 5, "fastag_id": "TEST", "vehicle_type": "car"},  # Invalid lane
            {"junction_id": 1, "lane_number": 1, "fastag_id": "", "vehicle_type": "car"},  # Empty fastag
        ]
    ...
    async def test_unsupported_methods(self, aio_session: aiohttp.ClientSession):
        ...
        async with aio_session.get(f"{self.API_BASE_URL}/vehicle-detection") as response:
            assert response.status == 405  # Method not allowed
